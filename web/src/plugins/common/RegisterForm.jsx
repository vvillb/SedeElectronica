...
render() {
return (
<form action="tu-accion" onSubmit={this.onFormSubmit}>
<div className="dx-fieldset">
<div className="dx-fieldset-header">Credenciales</div>
<div className="dx-field">
<div className="dx-field-label">Correo electrónico</div>
<div className="dx-field-value">
<TextBox>
<Validator>
<RequiredRule message="El correo electrónico es obligatorio" />
<EmailRule message="El correo electrónico es inválido" />
<AsyncRule
...
<div className="dx-field">
<div className="dx-field-label">Contraseña</div>
<div className="dx-field-value">
<TextBox
...
<div className="dx-field">
<div className="dx-field-label">Confirmar contraseña</div>
<div className="dx-field-value">
<TextBox
